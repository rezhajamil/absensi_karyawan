...
class Rekap extends CI_Controller
{
    ...
    public function ajax_list_laporan($id)
    {
        ...
        $data['segment'] = $id;
        // $this->load->view("rekap/ModalLaporan", compact('data', 'start', 'end', 'user', 'divisi'));

        $modal_content = $this->load->view("rekap/ModalLaporan", compact('data', 'start', 'end', 'user', 'divisi'), true);
