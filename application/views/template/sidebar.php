    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="<?php echo base_url() ?>assets/dist/img/teguh.jpg" class="img-circle" alt="User Image">
            </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu menu-open" style="display: block;">
                        ...
                        <li><a href="<?php echo base_url('divisi') ?>"><i class="fa fa-home"></i> <span>DATA DIVISI</span></a></li>
