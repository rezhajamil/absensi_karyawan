        ...
        <div class='col-xs-12'>
            <div class='box box-success'>
                <div class='box-header with-border'>
                    <?php $divisi = $this->Divisi_model->get_by_id($segment = $this->uri->segment(3)); ?>
                    <h4 class='box-title'>TABEL DATA <?php echo $divisi->nama_divisi ?></h3><br>
                </div><!-- /.box-header -->
                <div class='box-body'>
                        ...
                        <tbody>
                            ...
                            foreach ($divisi_data as $divisi) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $divisi->id_karyawan ?></td>
                                    <td><?php echo $divisi->nama_karyawan ?></td>
                                    <td><?php echo $divisi->nama_shift ?></td>
                                    <td><?php echo $divisi->nama_gedung ?></td>
                                    <td><?php echo $divisi->alamat ?></td>
                                </tr> <?php }  ?>
                        </tbody>
                        <tr>
                            <td colspan="6" style="text-align:center;"><?php echo anchor('divisi', 'Kembali', array('class' => 'btn btn-indigo btn-lg btn3d')); ?></td>
                        </tr>
                    </table>
                            ...
                            $("#mytable")
                                ...
                                .dataTable({
                                    ...
                                    buttons: [
                                        ...
                                        {
                                            extend: 'excel',
                                            title: 'DATA <?php echo $divisi->nama_divisi ?>',
                                            exportOptions: {
                                                columns: [0, 1, 2, 3],
                                            },
                                        },
